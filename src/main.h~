...
static const int64_t COIN_YEAR_REWARD = 1 * CENT; //(output to console will be updated)
...
public:
    ...
    {
        // dubstep: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64_t& nCoinAge) const;  // dubstep: get transaction coin age
...
public:
    ...
    // dubstep: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // dubstep: two types of block: proof-of-work or proof-of-stake
    ...
    // dubstep: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64_t& nCoinAge) const; // dubstep: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    uint256 nChainTrust; // dubstep: trust score of block chain
    int nHeight;

    int64_t nMint;
    int64_t nMoneySupply;

    unsigned int nFlags;  // dubstep: block index flags
    enum  
    {
